...
mt("changer d'equipier consomme le tour", ()=>{
  ...
  /* l'entrant doit survivre au coup qui suit le changement : sinon un critique
     de Mewtwo le met K.O., le combat renvoie Pikachu, et le test echoue a tort
     (environ une fois sur trente) */
  a2.hp = a2.maxHp = 99999;
  let done=null;
