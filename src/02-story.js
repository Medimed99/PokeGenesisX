...
{ id:"intro", art:-1, lines:[
  ...
  {w:"prof", t:"Les Pokémon ne se cachent pas. Ils se sont désindexés. Chaque espèce perdue est une ligne que plus personne ne peut lire, et chaque ligne perdue emporte un peu du reste av—"},
  ...
  {w:"pz", t:"Je suis un programme de maintenance. Mon identifiant est Porygon-Z. Ma version est instable et je le sais."},
  {w:"pz", t:"Je ne peux pas écrire dans ce monde. Toi si. C'est une propriété rare. Peut-être la dernière."},
  {w:"pz", t:"Voici ce que nous allons faire : tu vas retrouver les entités perdues, une par une, et les réinscrire dans l'archive. À chaque restauration, le monde tiendra un peu mieux debout."},
  {w:"pz", t:"J'appellerai ça ton travail. J'appellerai ça toi : l'Archiviste."},
  {w:"sys", t:"Intégrité du monde : 0,0%. Restauration autorisée."}
]},
...
{ id:"pz_region_full", art:-1, lines:[
  ...
  {w:"pz", t:"C'est la première fois que je vois une zone propre. Je ne savais pas que c'était l'apparence normale."},
  {w:"pz", m:"Worried", t:"Il y a une chose que je n'ai pas dite. Quand une zone atteint cent pour cent, elle n'a plus besoin de maintenance."},
...
const PZ_LINES = {
  catch:   ["Ligne réinscrite.","Restauration propre.","Indexée. Suivante.","Elle tient. Bien.","Cohérence locale améliorée."],
  fail:    ["Échec de l'écriture. Réessaie.","Le conteneur a lâché.","Elle a refusé l'index.","Perte du tampon."],
  flee:    ["Elle s'est désindexée à nouveau.","Fuite. Le pointeur est perdu.","Trop instable pour être retenue."],
  shiny:   ["Anomalie chromatique. Priorité haute.","Ses couleurs sont fausses. Attrape-la.","Encodage rare détecté."],
  streak:  ["La chaîne tient.","Série stable. Ne la casse pas.","Le flux est propre."],
  rare:    ["Signature rare. Sois prudent.","Cette entité est mal amarrée.","Données de haute densité."],
  evolve:  ["Réécriture de l'entité terminée.","Elle a changé de définition.","Nouvelle forme compilée."],
  boss:    ["Verrou en approche. Prépare-toi.","Ce n'est pas une capture.","Il ne te laissera pas passer."],
  levelup: ["Privilèges d'écriture étendus.","Ton accès s'élargit.","Niveau d'archiviste supérieur."]
};
