...
SCREENS.bag = {
  html(){
    ...
    return `
      ...
      <div class="sub">Ce qui s'active se trouve ici. Les Balls, baies et pierres s'utilisent
  ...
  reserves(){
    ...
    const body = line("Balls", balls, "Capture", "capture")
  ...
  balls(){
    ...
    if(!rows.length) return this.empty("Aucune Ball. Sans Ball, aucune capture n'est possible.");
